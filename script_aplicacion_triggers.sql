...
-- drop trigger if exists venta_inventario;
delimiter //
create trigger venta_inventario
after insert on factura
for each row
begin
	update inventario set cantidad = cantidad - new.cantidad where id_producto = new.id_producto;
end
//

select * from inventario;

-- drop trigger if exists compra_inventario;
delimiter //
create trigger compra_inventario
